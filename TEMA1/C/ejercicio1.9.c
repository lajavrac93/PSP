...
int main()
{
    ...
    if (pid_hijo1 == 0)
    {
        ...
        case 0: // proceso hijo
            ...
            //NIETO ENVIA
            printf("NIETO ENVIA MENSAJE a su Abuelo mediante el padre...%s\n", saludoNieto);
            close(fd1[0]);
        ...
        default: // proceso padre
            ...
            printf("Padre reenvia: abuelo -> nieto\n");

            //Padre ENVIA a su hijo
            ...
            //Padre ENVIA a Abuelo

            close(fd2[0]);
            write(fd2[1], buffer,
                  strlen(buffer)); //escribo en pipe
            printf("Padre reenvia: nieto->abuelo\n");
        }
    }
    else
    {
        //Nos encontramos en Proceso Abuelo
        //Abuelo ENVIA
        printf("ABUELO ENVIA MENSAJE AL Padre (para el nieto):%s\n", saludoAbuelo);
        ...
        printf("El ABUELO RECIBE MENSAJE del Nieto mediante el padre: %s\n", buffer);
    }
    exit(0);
}
